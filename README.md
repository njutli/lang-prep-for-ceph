...
| 03 | **并发与异步基础** | 2周 | **P0** | 线程/锁/CAS/内存模型(重中之重) |
| 04 | 现代C++特性 | 1周 | P1 | auto/lambda/右值引用 |
| 05 | 模板阅读能力 | - | P1 | 能看懂模板定义 |
| 06 | Boost/Seastar | - | P2 | 高性能库基础 |
| 07 | 异步编程实战 | - | P2 | 异步IO/协程 |
| 08 | Shell基础 | 1周 | P0 | 构建/测试/日志收集 |
| 09 | Python基础 | 1周 | P0 | 运维工具/MGR模块 |
| 10 | Ceph源码实战 | - | **P0** | 路径追踪、核心逻辑阅读 |
